 ...
 */
final class Version20200422142922 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE thanks_category ADD title VARCHAR(255) NOT NULL, ADD subtitle VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE thanks_category DROP title, DROP subtitle');
