 ...
 */
final class Version20200501055232 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE staff ADD enable TINYINT(1) NOT NULL');
        $this->addSql('ALTER TABLE thanks ADD enable TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE dev_progression CHANGE under_maintenance under_maintenance TINYINT(1) DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE staff DROP enable');
        $this->addSql('ALTER TABLE thanks DROP enable');
