 ...
 */
final class Version20200404060253 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_A21BC4DDDADD4A25 ON survey_answer_list (answer)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_A21BC4DDDADD4A25 ON survey_answer_list');
