 ...
 */
final class Version20200527220819 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE forum_discussion (id INT AUTO_INCREMENT NOT NULL, created_by_id INT DEFAULT NULL, sub_category_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, message LONGTEXT NOT NULL, pin TINYINT(1) DEFAULT NULL, archive TINYINT(1) DEFAULT NULL, created_at DATETIME NOT NULL, staff_only TINYINT(1) DEFAULT NULL, slug VARCHAR(255) NOT NULL, INDEX IDX_428F444AB03A8386 (created_by_id), INDEX IDX_428F444AF7BFE87C (sub_category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE forum_sub_category ADD description LONGTEXT DEFAULT NULL, ADD accept_staff_only TINYINT(1) DEFAULT \'0\' NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE forum_sub_category DROP description, DROP accept_staff_only');
        $this->addSql('ALTER TABLE staff_category CHANGE priority priority SMALLINT DEFAULT NULL');
